...
Bu dosya YALNIZCA kendi sınav dönemini (bulunduğu src/ klasörünü) kapsar;
her dönemin kendi kitap.py'si vardır.

Kullanıcı açıkça "birleşik kitaba ekle" derse, tek yapılacak iş COURSE_MODULES
listesine bir satır eklemektir — kitap kendini baştan numaralar, ana içindekilerini,
...
# Proje kökü (build.py, content_model.py vb.) src/ -> <sinav> -> <donem> ->
# <sinif> -> KÖK  => 4 seviye yukarıda.
